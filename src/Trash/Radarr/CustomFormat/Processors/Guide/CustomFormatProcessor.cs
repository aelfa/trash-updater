...
namespace Trash.Radarr.CustomFormat.Processors.Guide
{
    public class CustomFormatProcessor
    {
            ...
            CustomFormatCache? cache)
        {
            ...
            ProcessedCustomFormats.AddRange(customFormatGuideData
            ...
            if (cache != null)
            {
                DeletedCustomFormatsInCache.AddRange(cache.TrashIdMappings.Where(
                    map => !ProcessedCustomFormats.Any(
                        cf => cf.CacheEntry != null && cf.CacheEntry.TrashId == map.TrashId)));
            }
        }
            ...
            CustomFormatCache? cache)
        {
            ...
            newData.CacheEntry = cache?.FindCacheEntry(newData);
            return newData;
        }
    }
}
